from tkinter import *
from main_withGUI import get_response, bot_name
...
class ChatGUI:
    ...
    def _setup_main_window(self):
        ...
        #head label
        head_label = Label(self.window, bg = BG_COLOR, fg = TEXT_COLOR, text = "Welcome", font = FONT_BOLD, pady = 10) #from tkinter
        ...
        self.text_widget.insert(END, "Let's chat! type 'quit' to exit\n")
